...
async function seedConfiguration() {
  ...
  const certTypesData = [
    ...
    { code: "LIFT", name: "Lift Thorough Examination (LOLER)", shortName: "Lift/LOLER", complianceStream: "LIFTING", description: "Six-monthly lift inspection under LOLER 1998", validityMonths: 6, warningDays: 30, requiredFields: ["examinationDate", "engineerName", "liftId", "safeForUse", "nextExaminationDate"], displayOrder: 81, isActive: true },
    { code: "LIFT_M", name: "Lift Monthly Check", shortName: "Lift Monthly", complianceStream: "LIFTING", description: "Monthly lift safety check for high-rise buildings", validityMonths: 1, warningDays: 7, requiredFields: ["checkDate", "checkerName", "result"], displayOrder: 82, isActive: true },
    { code: "STAIR", name: "Stairlift Examination", shortName: "Stairlift", complianceStream: "LIFTING", description: "Six-monthly stairlift thorough examination", validityMonths: 6, warningDays: 30, requiredFields: ["examinationDate", "engineerName", "safeForUse"], displayOrder: 83, isActive: true },
    { code: "HOIST", name: "Hoist Examination", shortName: "Hoist", complianceStream: "LIFTING", description: "Six-monthly hoist thorough examination", validityMonths: 6, warningDays: 30, requiredFields: ["examinationDate", "engineerName", "safeForUse"], displayOrder: 84, isActive: true },
    { code: "PLAT", name: "Platform Lift Examination", shortName: "Platform Lift", complianceStream: "LIFTING", description: "Six-monthly platform lift thorough examination", validityMonths: 6, warningDays: 30, requiredFields: ["examinationDate", "engineerName", "safeForUse"], displayOrder: 85, isActive: true },
    ...
    { code: "PLAY", name: "Playground Inspection", shortName: "Playground", complianceStream: "EXTERNAL", description: "Annual playground equipment safety inspection", validityMonths: 12, warningDays: 60, requiredFields: ["inspectionDate", "inspectorName", "equipmentList", "findings"], displayOrder: 101, isActive: true },
    { code: "PLAY_Q", name: "Playground Quarterly Inspection", shortName: "Playground Q", complianceStream: "EXTERNAL", description: "Quarterly operational playground inspection", validityMonths: 3, warningDays: 14, requiredFields: ["inspectionDate", "inspectorName", "findings"], displayOrder: 102, isActive: true },
    { code: "TREE", name: "Tree Survey", shortName: "Tree Survey", complianceStream: "EXTERNAL", description: "Tree condition survey (3-year cycle)", validityMonths: 36, warningDays: 90, requiredFields: ["surveyDate", "arboristName", "treesAssessed", "recommendations"], displayOrder: 103, isActive: true },
    
    // ========== ACCESS/SECURITY EQUIPMENT (106-110) ==========
    { code: "FALL", name: "Fall Arrest System Certificate", shortName: "Fall Arrest", complianceStream: "SECURITY", description: "Annual fall arrest and anchor point inspection", validityMonths: 12, warningDays: 30, requiredFields: ["inspectionDate", "inspectorName", "anchorCount", "result"], displayOrder: 106, isActive: true },
    { code: "ACCESS", name: "Access Equipment Inspection", shortName: "Access Equip", complianceStream: "SECURITY", description: "Annual access equipment and ladders inspection", validityMonths: 12, warningDays: 30, requiredFields: ["inspectionDate", "inspectorName", "equipmentList"], displayOrder: 107, isActive: true },
...
async function seedNavigation() {
  ...
  const itemsData = [
    ...
    { sectionId: "sec-understand", slug: "report-canvas", name: "Report Canvas", href: "/reports/canvas", iconKey: "Palette", displayOrder: 5, isSystem: true },
    { sectionId: "sec-understand", slug: "compliance-treemap", name: "Compliance TreeMap", href: "/analytics/asset-health", iconKey: "LayoutGrid", displayOrder: 6, isSystem: true },
    { sectionId: "sec-understand", slug: "asset-health", name: "Asset Health", href: "/admin/asset-health", iconKey: "HeartPulse", displayOrder: 7, requiresFactorySettings: true, isSystem: true },
    { sectionId: "sec-understand", slug: "ml-predictions", name: "ML Predictions", href: "/admin/ml-insights", iconKey: "TrendingUp", displayOrder: 8, requiresFactorySettings: true, isSystem: true },
    { sectionId: "sec-understand", slug: "model-insights", name: "Model Insights", href: "/model-insights", iconKey: "Brain", displayOrder: 9, isSystem: true },
    ...
    { sectionId: "sec-manage", slug: "cloud-config", name: "Cloud Providers", href: "/admin/cloud-config", iconKey: "Cloud", displayOrder: 4, requiresFactorySettings: true, isSystem: true },
    { sectionId: "sec-manage", slug: "integrations", name: "Integrations", href: "/admin/integrations", iconKey: "Webhook", displayOrder: 5, isSystem: true },
    { sectionId: "sec-manage", slug: "api-integration", name: "API Integration", href: "/admin/api-integration", iconKey: "Key", displayOrder: 6, isSystem: true },
    { sectionId: "sec-manage", slug: "api-docs", name: "API Documentation", href: "/admin/api-docs", iconKey: "BookOpen", displayOrder: 7, isSystem: true },
    { sectionId: "sec-manage", slug: "knowledge-training", name: "Knowledge Training", href: "/admin/knowledge-training", iconKey: "Brain", displayOrder: 8, isSystem: true },
    { sectionId: "sec-manage", slug: "navigation-mgmt", name: "Navigation", href: "/admin/navigation", iconKey: "Navigation", displayOrder: 9, isSystem: true },
